...
pub enum Error {
    ...
    // Returned when a configuration parameter (threshold, cooldown, limit, delay, etc.)
    // is invalid or out of allowed bounds.
    InvalidConfigValue = 16,
