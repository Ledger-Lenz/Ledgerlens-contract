...
\* now <= 10 covers: 2 full refill cycles, 1 full commit-reveal-finalize-reset
\* cycle, the full governance lifecycle (propose at 1, executable at 3, expires
\* at 4), and at least 2 full COOLDOWN cycles (COOLDOWN=1) plus a subsequent
\* policy-compliant submission — required to exercise all five liveness
\* properties above within the bounded check.
